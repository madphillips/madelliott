  ...
  <FaqsWrapper id="faqs">
    ...
    <FlexContainer wrap="wrap" justify="center">
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
        <FaqSectionTitle onClick="showQuestions(1)">
      ...
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
        <FaqSectionTitle onClick="showQuestions(2)">
          <img src="https://www.iconexperience.com/_img/o_collection_png/green_dark_grey/512x512/plain/dog.png" />
          <span>Guest Questions</span>
        </FaqSectionTitle>
      </Col>
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
      <FaqSectionTitle onClick="showQuestions(3)">
          <img src="https://www.iconexperience.com/_img/o_collection_png/green_dark_grey/512x512/plain/dog.png" />
          <span>Media Questions</span>
        </FaqSectionTitle>
      </Col>
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
      <FaqSectionTitle onClick="showQuestions(4)">
          <img src="https://www.iconexperience.com/_img/o_collection_png/green_dark_grey/512x512/plain/dog.png" />
          <span>Food &amp; Drink Questions</span>
        </FaqSectionTitle>
      </Col>
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
      <FaqSectionTitle onClick="showQuestions(5)">
          <img src="https://www.iconexperience.com/_img/o_collection_png/green_dark_grey/512x512/plain/dog.png" />
          <span>Transportation Questions</span>
        </FaqSectionTitle>
      </Col>
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
      <FaqSectionTitle onClick="showQuestions(6)">
          <img src="https://www.iconexperience.com/_img/o_collection_png/green_dark_grey/512x512/plain/dog.png" />
          <span>Registry Questions</span>
        </FaqSectionTitle>
      </Col>
      <Col id="faq" w={[1/2, 1/3, 1/4 ]}>
      <FaqSectionTitle onClick="showQuestions(7)">
          <img src="https://www.iconexperience.com/_img/o_collection_png/green_dark_grey/512x512/plain/dog.png" />
          <span>Contact Us</span>
        </FaqSectionTitle>
      </Col>
    </FlexContainer>
    <FlexContainer margin="0 4em 2em 4em">
      <FaqQuestions id="faq1" w={ 1 }>
        <ul>
          <li>
